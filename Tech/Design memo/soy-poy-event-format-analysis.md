...
### Type A: Open Mic Announcement (定型フォーマット)

```
第XX回オープンマイク開催のお知らせ🎤

次回のオープンマイクはMM/DD（曜日）です‼︎
...
■ 大切にしていること：3つのRespect
[Values section]
1. Space｜この空間への敬意
2. Others｜ここにいる他者への敬意
3. Yourself｜自分自身への敬意

📍 SOY-POY（ロバート下北沢） @robert.shimokitazawa

予約不要・途中参加OK！
```

### Type B: External/Collaboration Event
...
【日程】YYYY年MM月DD日（曜日）
【時間】開場HH:MM 開演HH:MM
【場所】[Venue name and address]
【料金】[Ticket price]+1ドリンク
...
```
【[Event Name]にお越しくださった皆さまへ】

[Introduction]

———

[Personal message/reflection]

———

[Event credits]
Photographed by @username
```
...
- **Dividers**: Used to separate major sections or quotes
